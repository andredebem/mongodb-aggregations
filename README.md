# Boas-vindas ao repositório do projeto MongoDB Aggregations!

Aqui você vai encontrar todos os detalhes de como usufruir do que foi desenvolvido.

Diferentemente dos outros projetos, foram utilizadas várias coleções, de forma que foi possível praticar em vários cenários os diversos operadores e estágios do `aggregation pipeline`.

Os dados sâo do **IMDB**, de empresas aéreas e também dados de deslocamento de pessoas que utilizam bicicletas.
...
- Cada arquivo contém apenas o código MQL do desafio resolvido.
...
1. Clone o repositório
  * `git clone https://github.com/andredebem/mongodb-aggregations.git`
  * Entre na pasta do repositório que você acabou de clonar;

2. Instale as dependências
  * `npm i` ou `npm install`

3. Agora você pode abrir cada arquivo `.js` presente **na pasta `challenges` do projeto**:
  * desafio1.js, desafio2.js, desafio3.js, desafio4.js, ..., desafioN.js

OU

1. Acesse o mesmo link deste repositório com `1s` depois de `github` e antes de `.com`
  * `https://github1s.com/andredebem/mongodb-aggregations`

2. Agora você pode abrir cada arquivo `.js` presente **na pasta `challenges` do projeto**:
  * desafio1.js, desafio2.js, desafio3.js, desafio4.js, ..., desafioN.js
